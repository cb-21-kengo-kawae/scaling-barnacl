...
find tmp/overwrite/ -name '.DS_Store' -type f -delete
cp -TRv tmp/overwrite /var/www
...
bundle exec rails ridgepole:apply ridgepole:apply migrations:change_policies account_record:ridgepole:apply[1]
