...
%w[
  should_matcher
  factory_bot
  account_record_helper
  database_cleaner
].each do |basename|
  require File.expand_path("./support/setup/#{basename}", __dir__)
end

# Supports
Dir[Rails.root.join('spec', 'support', 'shared', '**', '*.rb')].sort.each { |f| require f }
